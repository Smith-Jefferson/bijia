...
public class SqlUtil {
	...
	public SqlUtil(String dbName,String userName,String password){
		...
		String url="jdbc:mysql://localhost:3306/"
				+ dbName+"?user="+userName+"&password="+password+"&useUnicode=true&characterEncoding=utf-8"; 
	...
	public void getAll(String table){
		...
		try {
			...
			while(rs.next()) {
				  System.out.println(rs.getInt("P_Id") + "\t" + rs.getString("Iname")+"\t"+rs.getString("Iprice")+"\t"+rs.getString("Ithird_cat"));
			  }
		} catch (SQLException e) {
